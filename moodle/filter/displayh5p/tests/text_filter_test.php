...
final class text_filter_test extends \advanced_testcase {
    ...
    public static function texts_provider(): array {
        ...
        return [
            ...
            [
                $CFG->wwwroot . "/lib.php/5/user/private/interactive-video.h5p?export=1&embed=1",
                "#<iframe src=\"{$CFG->wwwroot}/h5p/embed.php\?url=" .
                    rawurlencode("{$CFG->wwwroot}/lib.php/5/user/private/interactive-video.h5p") .
                    "&export=1&embed=1\"[^>]*?></iframe>#",
            ],
            [
                $CFG->wwwroot . "/lib.php/5/user/private/accordion-6-7138%20%281%29.h5p.h5p",
                "#<iframe src=\"{$CFG->wwwroot}/h5p/embed.php\?url=" .
                    rawurlencode("{$CFG->wwwroot}/lib.php/5/user/private/accordion-6-7138%20%281%29.h5p.h5p") .
                    "\"[^>]*?></iframe>#",
            ],
        ];
    }
