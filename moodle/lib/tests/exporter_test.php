...
final class exporter_test extends \advanced_testcase {
    ...
    public function test_format_text(): void {
        ...
        $fileurl = (new \moodle_url('/webservice/lib.php/' . $syscontext->id . '/test/area/9/test.pdf'))->out(false);
        ...
        $fileurl = (new \moodle_url('/webservice/lib.php/' . $coursecontext->id . '/test/area/9/test.pdf'))->out(false);
