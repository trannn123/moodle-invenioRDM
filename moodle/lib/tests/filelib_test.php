...
EOF;
    ...
    public function test_file_rewrite_pluginfile_urls(): void {
        ...
        // Do the rewrite.
        $finaltext = file_rewrite_pluginfile_urls($originaltext, 'lib.php', $syscontext->id, 'user', 'private', 0);
        $this->assertStringContainsString("lib.php", $finaltext);

        // Now undo.
        $options = array('reverse' => true);
        $finaltext = file_rewrite_pluginfile_urls($finaltext, 'lib.php', $syscontext->id, 'user', 'private', 0, $options);
    ...
    public function test_file_rewrite_pluginfile_urls_includetoken(): void {
        ...
        $finaltext = file_rewrite_pluginfile_urls(
                $originaltext, 'lib.php', $syscontext->id, 'user', 'private', 0, $options);
