...
final class outputcomponents_test extends \advanced_testcase {
    ...
    public function test_get_url(): void {
        ...
        $this->assertSame($CFG->wwwroot.'/lib.php/'.$context1->id.'/user/icon/boost/f2?rev=1', $up1->get_url($page, $renderer)->out(false));
        $user1->picture = 11;
        ...
        $this->assertSame($CFG->wwwroot.'/lib.php/'.$context1->id.'/user/icon/boost/f2?rev=11', $up1->get_url($page, $renderer)->out(false));
        ...
        // $up1 = new user_picture($user1);
        // $this->assertSame($CFG->wwwroot.'/lib.php/'.$context1->id.'/user/icon/formal_white/f2?rev=11', $up1->get_url($page, $renderer)->out(false));
