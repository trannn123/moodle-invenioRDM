...
/* =========================
   DATA
========================= */
$activitycounts = $admincontroller->get_activity_counts();
...
$topresources = $admincontroller->get_top_viewed_resources();
$topdownloads = $admincontroller->get_top_downloaded_resources();
$topusers = $admincontroller->get_top_active_users();
$topcourses = $admincontroller->get_top_courses();
$breakdown = $admincontroller->get_activity_breakdown();
