...
class mod_workshop_renderer extends plugin_renderer_base {
    ...
    protected function render_workshop_submission(workshop_submission $submission) {
        ...
        $content = file_rewrite_pluginfile_urls($submission->content, 'lib.php', $this->page->context->id,
    ...
    protected function render_workshop_example_submission(workshop_example_submission $example) {
        ...
        $content = file_rewrite_pluginfile_urls($example->content, 'lib.php', $this->page->context->id,
        ...
        switch ($workshop->phase) {
            ...
            case workshop::PHASE_CLOSED:
                if (trim($workshop->conclusion)) {
                    $conclusion = file_rewrite_pluginfile_urls($workshop->conclusion, 'lib.php', $workshop->context->id,
